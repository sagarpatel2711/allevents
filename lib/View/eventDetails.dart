            ...
            Padding(
              ...
              child: Expanded(
                child: Column(
                  ...
                  children: [
                    _rowText(
                        icon: IconAssets.calenderIcon, text: "datetime".tr),
                    Padding(
                    ...
                    _rowText(
                        icon: Icons.location_on_outlined, text: "vanue".tr),
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          vertical: 5, horizontal: 5),
                      child: Text(
                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            onPressed: () {}, child: Text("booknow".tr))
                      ],
                    ),
                    Padding(
                      padding: const EdgeInsets.symmetric(
                    ...
                    _rowText(
                        icon: Icons.door_back_door, text: "eventphotos".tr),
                    ...
                    Container(
                      ...
                      width: Get.width,
                      decoration:
                          const BoxDecoration(color: AppColors.white54Color),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
