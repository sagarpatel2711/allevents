class CategoriesDataResponseModal {
  Request? request;
  int? count;
  List<Item>? item;

  CategoriesDataResponseModal({this.request, this.count, this.item});

  CategoriesDataResponseModal.fromJson(Map<String, dynamic> json) {
    request =
...
class Item {
  ...
  Item.fromJson(Map<String, dynamic> json) {
    ...
    customParams = json['custom_params'].cast<String>();
  }
